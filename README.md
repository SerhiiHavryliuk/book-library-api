...
## Serhii notest
1) Generate a new CRUD resource. See the CRUD (resource) generator for more details.

```bash
# Generate a new CRUD resource
$ nest g res books
```
- More - [article crud-generator](https://docs.nestjs.com/recipes/crud-generator)
